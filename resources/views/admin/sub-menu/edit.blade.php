        ...
        <div class="row">
            <div class="col-12 col-lg-8 offset-lg-2">
                ...
                <div class="d-flex justify-content-between align-items-center my-3">
                    <h4 class="m-0">
                        <i class="fas fa-pen-to-square mr-2 text-primary"></i> Edit Sub Menu
                    </h4>
                            ...
                            <div class="row">
                                    ...
                                    <select name="menu" id="menu"
                                        ...
                                        @foreach ($menus as $item)
                                            <option value="{{ $item->id }}"
                                                {{ old('menu', $subMenu->menuID) == $item->id ? 'selected' : '' }}>
                                                {{ $item->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('submenu', $subMenu->subMenuName) }}"
                                           required>
                                    @error('submenu')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea id="shortDescription"
                                              ...
                                              class="form-control @error('shortDescription') is-invalid @enderror">{{ old('shortDescription', $subMenu->shortDetails) }}</textarea>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea id="longDescription"
                                              ...
                                              class="form-control @error('longDescription') is-invalid @enderror">{{ old('longDescription', $subMenu->longDetails) }}</textarea>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    @if(!empty($subMenu->image))
                                        <div id="currentImageWrapper" class="mb-2">
                                            ...
                                            <a href="{{ asset('public/upload/'.$subMenu->image) }}" target="_blank" rel="noopener noreferrer">
