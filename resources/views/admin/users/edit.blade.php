                    ...
                    <div class="card-body">
                        <form action="{{ url('usermanage') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                    ...
                                    <select id="userrolle"
                                        ...
                                        @foreach($role as $item)
                                            <option value="{{ $item->id }}"
                                                {{ old('userrolle', $user->roleid) == $item->id ? 'selected' : '' }}>
                                                {{ $item->role }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-md-6">
                                    <label>
                                        <i class="fas fa-shield-alt mr-1 text-muted"></i> User Role
                                    </label>
                                    <input type="text" class="form-control bg-light" value="{{ $user->role_name }}" disabled>
                                    <small class="form-text text-muted">
                                        <i class="fas fa-lock mr-1"></i> Admin role cannot be changed.
                                    </small>
                                </div>
                                @endif
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="tel"
                                           ...
                                           value="{{ old('contactno', $user->contact_no) }}"
                                           required>
                                    @error('contactno')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('referenceper', $user->reference_by) }}">
                                    @error('referenceper')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    @if(!empty($user->nationalid))
                                        <div class="mb-2">
                                            <a href="{{ asset('public/upload/'.$user->nationalid) }}" target="_blank" rel="noopener noreferrer">
                                                <img src="{{ asset('public/upload/'.$user->nationalid) }}"
                                                     height="60" class="rounded border p-1" alt="Current National ID">
                                            </a>
                                            <small class="d-block text-muted mt-1">
                                                <i class="fas fa-info-circle mr-1"></i> Upload a new file to replace.
                                            </small>
                                        </div>
                                    @endif
                                    ...
                                    @if(!empty($user->agreement_paper))
                                        <div class="mb-2">
                                            <a href="{{ asset('public/upload/'.$user->agreement_paper) }}" target="_blank" rel="noopener noreferrer">
                                                <img src="{{ asset('public/upload/'.$user->agreement_paper) }}"
                                                     height="60" class="rounded border p-1" alt="Current Agreement Paper">
                                            </a>
                                            <small class="d-block text-muted mt-1">
                                                <i class="fas fa-info-circle mr-1"></i> Upload a new file to replace.
                                            </small>
